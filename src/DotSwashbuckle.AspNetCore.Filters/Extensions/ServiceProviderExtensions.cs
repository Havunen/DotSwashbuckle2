...
namespace DotSwashbuckle.AspNetCore.Filters.Extensions
{
    internal static class ServiceProviderExtensions
    {
        ...
        public static object GetExampleForType(this IServiceProvider serviceProvider, Type type)
        {
            ...
            var singleExample = serviceProvider.GetExampleWithExamplesProviderType(exampleProviderType);
            ...
            return serviceProvider.GetExampleWithExamplesProviderType(multipleExampleProviderType);
        }
