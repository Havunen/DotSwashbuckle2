...
namespace DotSwashbuckle.AspNetCore.Filters.Test.Examples
{
    ...
    public class GivenAMvcFormatterWitXmlOutputFormatter_WhenSerializingAnObjectAsXml
    {
        ...
        public void ThenValueIsSerialized()
        {
            ...
            sut.Serialize(value, contentType)
                .ShouldBe(
                    "<PersonResponse xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"http://schemas.datacontract.org/2004/07/DotSwashbuckle.AspNetCore.Filters.Test.TestFixtures.Examples\">" +
                    "<Age>27</Age>" +
                    "<Id>123</Id>" +
                    "<Income i:nil=\"true\" />" +
                    "<Title>Dr</Title>" +
